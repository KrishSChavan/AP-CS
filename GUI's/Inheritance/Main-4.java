    ...
    public void buttonClicked(JButton buttonObj) {
    	...
    	if (buttonObj == p) {
    		...
    		if (fieldsFilled == items.size()) {
    			if (type == "p") {
    				peopleList.add(new Person(nameF.getText()));
//					System.out.println(obj[count].print());
					countL.setText("People added: " + (count+1));
					
				} else if (type == "s") {
					peopleList.add(new Student(nameF.getText(), idF.getText()));
//					System.out.println(obj[count].print());
					countL.setText("People added: " + (count+1));
					
				} else if (type == "u") {
					peopleList.add(new UnderGrad(nameF.getText(), idF.getText(), glvlF.getText()));
//					System.out.println(obj[count].print());
					countL.setText("People added: " + (count+1));
					
				} else if (type == "g") {
					peopleList.add(new Grad(nameF.getText(), idF.getText(), mF.getText()));
//					System.out.println(obj[count].print());
					countL.setText("People added: " + (count+1));
    ...
    private void printThis(String type) {
    	...
    	if (type == "p") {
    		for (int i=0; i<count; i++) {
    			if (peopleList.get(i) instanceof Person) {
    				result += (peopleCount+1) + "| " + peopleList.get(i).print() + '\n';
    				peopleCount++;
    			}
    		}
    	} else if (type == "s") {
    		...
    		for (int i=0; i<count; i++) {
    			if (peopleList.get(i) instanceof UnderGrad) {
    				result += (peopleCount+1) + "| " + peopleList.get(i).print() + '\n';
    				peopleCount++;
    			}
    		}
    		...
    		for (int i=0; i<count; i++) {
    			if (peopleList.get(i) instanceof Grad) {
    				result += (peopleCount+1) + "| " + peopleList.get(i).print() + '\n';
    				peopleCount++;
    			}
    		}
...
//    	}
    	...
    	if (here == "GRADE") {
    		...
    		for (int i=0; i<peopleList.size(); i++) {
    			if (((UnderGrad) peopleList.get(i)).getGrade().equals(search.getText())) {
    	    		combo.addItem(peopleList.get(i).getName());
    			}
    		}

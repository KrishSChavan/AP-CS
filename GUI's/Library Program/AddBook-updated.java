...
//    IntegerField day5Fld = addIntegerField (0, 3,6,1,1);
    ...
    JButton okBtn = addButton ("OK", 5,2,2,1);
    JButton cancelBtn = addButton ("Cancel", 5,4,2,1);
...
//        day5Fld.setNumber (6);
	...
	public void buttonClicked(JButton buttonObj){
        ...
        if (buttonObj == okBtn){
        	...
        	System.out.print(new Library(authorFld.getText(), titleFld.getText(), true, borrowerFld.getText(), fullDate).toString());
